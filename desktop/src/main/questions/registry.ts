 ...
 *
 * Phase 4 will expand this with food, potion, phial, weapon-enchant, and
 * gem questions. Order doesn't affect SimC behavior but affects the order
 * of `profileset.` lines in the input — keep it stable for log readability.
 */
